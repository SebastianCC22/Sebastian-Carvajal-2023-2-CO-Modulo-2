...
from dino_runner.utils.constants import DEFAULT_TYPE, SHIELD_TYPE, HAMMER_TYPE, RUNNING, JUMPING, DUCKING, RUNNING_SHIELD, RUNNING_HAMMER, JUMPING_SHIELD, JUMPING_HAMMER, DUCKING_SHIELD, DUCKING_HAMMER
